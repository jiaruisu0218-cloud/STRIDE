...
from codes.evaluate import profile
...
def main(
    ...
    # Fresh run: clear cross-run stop flag (train NMSE early stop)
    sampler.Sampler.reset_stop()
    ...
    # Without parallelization only the first sampler runs the infinite loop.
    for s in samplers:
